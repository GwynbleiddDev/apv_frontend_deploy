  ...
  return (
    <>
      ...
      <div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
          ...
          <>
            <form onSubmit={handleSubmit}>
              ...
              <input 
                ...
                className="bg-indigo-700 w-full py-3 px-20 rounded-xl text-white uppercase font-bold mt-5 hover:cursos-pointer hover:bg-indigo-500 md:w-auto"
              />
            </form>
          </>
        )}
        ...
        {passwordModificado && (
            <Link Link className="block text-center my-5 text-gray-500" to="/">Iniciar Sesión</Link>
        )}
